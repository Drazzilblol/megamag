...
public class LocalMenuTheaterDataSource implements MenuDataSource {
    ...
    public Observable<List<MenuData>> getAll() {
        return Observable.just(getTheaterMenus());
    }
    ...
    private List<MenuData> getTheaterMenus() {
        String selection = MenuContract.COLUMN_NAME_TARGET_ID + " = " + 1002;
