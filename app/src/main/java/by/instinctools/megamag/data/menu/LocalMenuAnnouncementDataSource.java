...
public class LocalMenuAnnouncementDataSource implements MenuDataSource {
    ...
    public Observable<List<MenuData>> getAll() {
        return Observable.just(getAnnouncementsMenus());
    }
    ...
    private List<MenuData> getAnnouncementsMenus() {
        String selection = MenuContract.COLUMN_NAME_TARGET_ID + " = " + AnnouncementDataSource.ANNOUNCEMENT_GROUP_ID;
