...
<<<<<<<HEAD
    ...
    private List<InfoData> getStubBookInfo(@NonNull String infoId) {
        ...
        List<InfoItem> itemList2 = new ArrayList<>();

        itemList2.add(new InfoText("1.1. Выбор по дате, по объекту через вспомогательную область сеансов.\n" +
        ...
        List<InfoItem> itemList3 = new ArrayList<>();
        itemList3.add(new InfoText("На открывшейся странице нужно ознакомиться с условиями и правилами работы системы и поставить соответствующие отметки об ознакомлении с правилами бронирования\n" +
                "\n" +
