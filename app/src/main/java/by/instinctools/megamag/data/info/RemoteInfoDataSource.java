...
public class RemoteInfoDataSource implements InfoDataSource {
    ...
    private List<InfoData> getStubPayInfo(int infoId) {
        ...
        items1.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 1. Зайти на сайт Интернет-Банка</b><br>" +
        ...
        items1.add(InfoImage.builder()
                ...
                .build());
        items1.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 2. Выбрать в Платежах \"Билеты kinoteatr.megamag.by\"</b><br>\"" +
        ...
        items1.add(InfoImage.builder()
                ...
                .build());
        items1.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 3. Ввести номер заказа</b><br>" +
        ...
        items1.add(InfoImage.builder()
                ...
                .build());
        items1.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 4. Подтвердить оплату</b><br>" +
        ...
        items2.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 1. Выбрать в Платежах \"Билеты kinoteatr.megamag.by\".</b><br>" +
                ...
                .build());
        items2.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 2. Ввести номер заказа</b><br>" +
                        "Введите номер Вашего заказа и нажмите кнопку \"Далее\". Номер заказа можно увидеть в Кабинете пользователя, в Истории заказов, а также в письме, которое автоматически отправляется на электронную почту после оформления заказа."))
                .build());
        items2.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 3. Подтвердить оплату</b><br>" +
                        "В следующем окне будет отображена информация по заказу: содержание и стоимость. Проверьте информацию о билетах, которые собираетесь оплачивать и нажмите кнопку \"Далее\"."))
                .build());
        items2.add(InfoText.builder()
                .data(replaceNToBr("<b>Пункт 4. Завершить оплату</b><br>" +
    ...
    private List<InfoData> getStubRulesInfo(int infoId) {
        ...
        itemList.add(InfoText.builder()
                .data(replaceNToBr("<b>Правила киновидеообслуживания населения</b><br>" +
