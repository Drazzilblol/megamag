...
public class RemoteInfoDataSource implements InfoDataSource {
    ...
    private List<InfoData> getStubPayInfo(@NonNull String infoId) {
        ...
        items1.add(new InfoText("<b>Пункт 1. Зайти на сайт Интернет-Банка</b>" +
                ...
                items1.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howpay/var1_step1.jpg"));
        items1.add(new InfoText("<b>Пункт 2. Выбрать в Платежах \"Билеты kinoteatr.megamag.by</b>\"\n" +
                ...
                "Для остальных интернет-банкингов делать все по аналогии."));
        items1.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howpay/var1_step2.jpg"));
        items1.add(new InfoText("<b>Пункт 3. Ввести номер заказа\n</b>" +
        ...
        items1.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howpay/var1_step3.jpg"));
        items1.add(new InfoText("<b>Пункт 4. Подтвердить оплату\n</b>" +
        ...
        items1.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howpay/var1_step4.jpg"));
        ...
        items2.add(new InfoText("<b>Пункт 1. Выбрать в Платежах \"Билеты kinoteatr.megamag.by\".\n</b>" +
        ...
        items2.add(new InfoText("<>Пункт 2. Ввести номер заказа\n" +
                "Введите номер Вашего заказа и нажмите кнопку \"Далее\". Номер заказа можно увидеть в Кабинете пользователя, в Истории заказов, а также в письме, которое автоматически отправляется на электронную почту после оформления заказа."));
        items2.add(new InfoText("<b>Пункт 3. Подтвердить оплату\n</b>" +
                "В следующем окне будет отображена информация по заказу: содержание и стоимость. Проверьте информацию о билетах, которые собираетесь оплачивать и нажмите кнопку \"Далее\"."));
        items2.add(new InfoText("<b>Пункт 4. Завершить оплату\n</b>" +
    ...
    private List<InfoData> getStubBookInfo(@NonNull String infoId) {
        ...
        List<InfoItem> items1 = new ArrayList<>();
        items1.add(new InfoText("Бронирование билетов доступно ТОЛЬКО зарегистрированным клиентам системы Мегамаг, поэтому первым шагом является регистрация на сайте.\n"));
        items1.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howbronned/step0_1.jpg"));
        items1.add(new InfoText("Если регистрация прошла успешно, то в правой верхней части сайта появится надпись – ваше имя.\n"));
        items1.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howbronned/step0_2.jpg"));
        items1.add(new InfoText("После регистрации или авторизации на сайте (для зарегистрированных ранее) можно переходить к бронированию билетов."));
        ...
        items2.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howbronned/step1_1_1.jpg"));
        ...
        items3.add(new InfoText("Меню \"Кино и театры региона\" находится в левой части сайта, под главным меню.\n"));
        items3.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howbronned/step1_2_1.jpg"));
        items3.add(new InfoText("Выбрать (нажать на название) необходимый объект из списка\n"
        ...
        items3.add(new InfoImage("http://kinoteatr.megamag.by/templates/Cinema-new/images/howbronned/step1_2_2.jpg"));
        items3.add(new InfoText("На этом изображении необходимо выбрать места. Выбранные места на плане зала окрашиваются в фиолетовый цвет. После выбора мест можно переходить в следующий этап."));
    ...
    private List<InfoData> getStubRulesInfo(@NonNull String infoId) {
        ...
        itemList.add(new InfoText("<b>Правила киновидеообслуживания населения</b>\n" +
